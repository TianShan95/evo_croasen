#!/bin/bash
python evaluator.py --subnet .tmp/iter_0/net_0_subnet.txt --supernet_path ../experiment/evo_croasen/super_net/super_model_best.pth.tar --save .tmp/iter_0/net_0_stats.txt --n_epochs 5 &
...
python evaluator.py --subnet .tmp/iter_0/net_4_subnet.txt --supernet_path ../experiment/evo_croasen/super_net/super_model_best.pth.tar --save .tmp/iter_0/net_4_stats.txt --n_epochs 5 &
